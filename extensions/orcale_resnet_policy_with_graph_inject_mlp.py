...
class PointNavResNetPolicyWithGraphInjectMLP(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithGraphNetInjectMLP(
...
class PointNavResNetWithGraphNetInjectMLP(Net):
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithGraphNetInjectMLP.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
