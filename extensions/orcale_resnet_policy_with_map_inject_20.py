...
class PointNavResNetPolicyWithMapInject20(NetPolicy):
    def __init__(
        self,
...
class SimpleResNet(nn.Module):
    def __init__(self, block, layers):
        ...
        self.conv1 = nn.Conv2d(20, 32, kernel_size=7, stride=2, padding=3, bias=False)
...
class PointNavResNetWithMapInject20(Net):
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithMapInject20.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
