...
class PointNavResNetPolicyWithMapInjectNonBN(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithMapInjectNonBN(
...
class PointNavResNetWithMapInjectNonBN(Net):
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithMapInjectNonBN.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
