...
class PointNavResNetPolicyWithGraphInjectNonAff(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithGraphNetInjectNonAff(
...
class PointNavResNetWithGraphNetInjectNonAff(Net):
    ...
    def __init__(
        ...
        self.graph_projector = nn.Linear(5 * 6* 32, 256)
        self.graph_projector1 = nn.Linear(256, 128)
        # self.bn1 = nn.BatchNorm1d(128)
        self.layer_norm2 = nn.LayerNorm(256, elementwise_affine=False)
        
        self.layer_norm = nn.LayerNorm([5,6,32], elementwise_affine=False)
        self.layer_norm1 = nn.LayerNorm([5,6,32], elementwise_affine=False)
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithGraphNetInjectNonAff.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
