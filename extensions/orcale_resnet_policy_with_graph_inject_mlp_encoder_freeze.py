...
class PointNavResNetPolicyWithGraphInjectMLPEnocderFreeze(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithGraphNetInjectMLPEnocderFreeze(
...
class PointNavResNetWithGraphNetInjectMLPEnocderFreeze(Net):
    ...
    def forward(
        ...
        node_features = self.relu(self.graph_pos_encoder(human_future_trajectory))

        final_graph_feature = node_features.reshape(node_features.shape[0], -1 )
        final_graph_feature = self.graph_projector(final_graph_feature)
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithGraphNetInjectMLPEnocderFreeze.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
