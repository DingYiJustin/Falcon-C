...
class PointNavResNetPolicyWithGraphSpec(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithGraphNetSpec(
...
class PointNavResNetWithGraphNetSpec(Net):
    ...
    def __init__(
        ...
        # self.scaler_predictor = nn.Linear((self._hidden_size+ rnn_input_size)*2, (self._hidden_size+ rnn_input_size)*2)
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithGraphNetSpec.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
