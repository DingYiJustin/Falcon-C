...
class PointNavResNetPolicyWithMapInject(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.critic_net = PointNavResNetWithMapInject(
    ...
    def act(
        ...
        features, rnn_hidden_states, _ = self.critic_net(
            observations, rnn_hidden_states, prev_actions, masks
        )
...
def GetSimpleResnet18ForMap():
    ...
    return SimpleResNet(SimpleResNetBasicBlock, [2, 2, 2, 2])
        

class PointNavResNetWithMapInject(Net):
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithMapInject.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
