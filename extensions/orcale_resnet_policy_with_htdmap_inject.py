...
class PointNavResNetPolicyWithHTDMapInject(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(
            PointNavResNetWithHTDMapInject(
...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        self.visual_keys = [
            ...
            if len(v.shape) > 1 and k != ImageGoalSensor.cls_uuid and k != "oracle_humanoid_future_trajectory" and k != 'obstacle_map'and k != "oracle_humanoid_future_trajectory_map" and k != 'oracle_humanoid_future_trajectory_map_count' and k != 'td_map'
        ]
...
class SimpleResNet(nn.Module):
    def __init__(self, block, layers):
        ...
        self.conv1 = nn.Conv2d(8, 32, kernel_size=7, stride=2, padding=3, bias=False)
...
class PointNavResNetWithHTDMapInject(Net):
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetWithHTDMapInject.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
