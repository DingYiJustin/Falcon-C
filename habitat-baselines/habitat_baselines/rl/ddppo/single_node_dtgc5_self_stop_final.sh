...
python -u -m torch.distributed.launch \
    ...
    --config-name=social_nav_v2/dtgc5_self_stop_final_hm3d_train.yaml \
    > evaluation/dtgc5_self_stop_final/hm3d/train.log 2>&1
