...
# set -x
python -u -m assist_training_resnet.py > evaluation/dtgcf_self_stop_final_fast_a40/hm3d/c_train.log 2>&1 &
...
python -u -m torch.distributed.launch \
    ...
    --config-name=social_nav_v2/dtgcf_self_stop_final_hm3d_train_fast_a40.yaml \
    > evaluation/dtgcf_self_stop_final_fast_a40/hm3d/train.log 2>&1
