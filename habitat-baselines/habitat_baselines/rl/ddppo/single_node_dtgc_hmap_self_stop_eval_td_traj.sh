...
python -u -m habitat-baselines.habitat_baselines.run \
    --config-name=social_nav_v2/dtgc_hmap_self_stop_hm3d_eval_with_csv_tdtraj_map.yaml \
    > evaluation/dtgc5_hmap_self_stop/hm3d/eval-dtgcf-tdmaptraj-ckpt56.log 2>&1
