...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        self.visual_keys = [
            ...
            if len(v.shape) > 1 and k != ImageGoalSensor.cls_uuid and k != "oracle_humanoid_future_trajectory" and k !='td_map' and k != 'oracle_humanoid_future_trajectory_map' and k != "td_map_with_traj"
        ]
